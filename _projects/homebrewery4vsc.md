---
layout: project
title: Homebrewery for VS Code
date: 2026-03-13
description: Edit content for your favorite RPG (D&D) in your favorite editor (VS Code).
...
categories:
  ...
  - Code
  - Geek
image: /images/projects/homebrewery4vsc-banner.jpg
learn_more: Read
image-credits: Picture by <a href="https://unsplash.com/fr/@galxrax?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText" target="_blank">Galxrax rax</a> (Unsplash)
---
...
That’s exactly the problem [**Homebrewery for VS Code**](https://marketplace.visualstudio.com/items?itemName=iffrit.homebrewery4vsc&ssr=false#overview){:target="_blank"} tries to solve.

![Homebrewery for VS Code in Action](https://github.com/fxnicolas/homebrewery4vsc/raw/HEAD/media/images/homebrewery4vsc-demo.gif)
*Homebrewery for VS Code in Action*{: style="text-align: center; font-size: 0.85em; display: block;"}
...
You can install the Homebrewery for VS Code extension from the **VS Code Marketplace**. It is **free and [open-source](https://github.com/fxnicolas/homebrewery4vsc){:target="_blank"}**, and the author (me) has no intention to make money from this work. I needed this tool to manage my own content and wanted to sharpen my coding skills. Then I got excited and ended up with something I could publish.